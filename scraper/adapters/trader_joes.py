"""Trader Joe's adapter (fixture-driven)."""
...
class TraderJoesAdapter(RetailerAdapter):
    retailer = "trader_joes"
    entry_urls = ["https://www.traderjoes.com/home/products/category/food-8"]
    min_delay = 1.5
    max_delay = 3.5

    _PRODUCT_PATH = re.compile(r"/products/pdp/")
    _CATEGORY_PATH = re.compile(r"/products/category/")
